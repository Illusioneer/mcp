...
class AlarmsControllerTest < ActionController::TestCase
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post :create, alarm: { category: @alarm.category, enddate: @alarm.enddate, name: @alarm.name, notify: @alarm.notify, reqs: @alarm.reqs, startdate: @alarm.startdate }
    end
  ...
  test "should update alarm" do
    put :update, id: @alarm, alarm: { category: @alarm.category, enddate: @alarm.enddate, name: @alarm.name, notify: @alarm.notify, reqs: @alarm.reqs, startdate: @alarm.startdate }
    assert_redirected_to alarm_path(assigns(:alarm))
  end
